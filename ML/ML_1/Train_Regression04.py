...
def main():
    ...
    print(f"Mean Squared Error for Sepal Length and Width to Petal Width: {mse}")
    ...
    plt.legend()
    plt.savefig('sepal_length_width_to_petal_width_loss.png')
    plt.show()

    # For plotting predicted vs actual values, use a scatter plot
